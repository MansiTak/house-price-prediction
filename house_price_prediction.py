...
def save_outputs(pipeline, X_train, y_test, y_pred):
...
# Expose one example function for testing GitHub Actions
...
if __name__ == "__main__":
    ...
    save_outputs(pipeline, X, y_test.reset_index(drop=True), pd.Series(y_pred).reset_index(drop=True))
